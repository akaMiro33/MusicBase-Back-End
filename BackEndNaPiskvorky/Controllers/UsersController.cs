...
namespace BackEndNaPiskvorky.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public UsersController(PiskvorkyContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> GetUserByName([FromRoute] string name)
        {
            ...
            var user = await _context.User.FirstAsync(x => x.Name == name);
        ...
        public async Task<IActionResult> PostUser([FromBody] User user)
        {
            if (!ModelState.IsValid)
            {
             ...
             User foundUser;
             foundUser = await _context.User.FirstOrDefaultAsync(x => x.Name == user.Name);
